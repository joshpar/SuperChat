...
extension MainViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        chatViewController.samuraiTransition.zan = .chopped(oneSide: 40.0)
        chatViewController.samuraiTransition.isAffineTransform = true
        chatViewController.samuraiTransition.duration = 3
